...
gui.add(debuggerObject, "createSphere");
gui.add(debuggerObject, "createBox");
gui.add(debuggerObject, "reset");
...
const createSphere = (radius, position) => {
  // 1. Create THREE.JS Object and Add *SCENE*
  ...
  // 2. Create CANNON JS Body and Add *WORLD*
